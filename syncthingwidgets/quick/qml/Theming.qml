...
QtObject {
    ...
    Material.primary: currentPage?.isDangerous ? Material.Red : Material.LightBlue
    Material.accent: QuickUI.darkmodeEnabled ? Material.color(currentPage?.isDangerous ? Material.Red : Material.LightBlue, Material.Shade200) : Material.primary
    ...
    function baseColor(palette): color {
