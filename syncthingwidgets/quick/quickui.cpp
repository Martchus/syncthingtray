...
QuickUI::QuickUI(QGuiApplication *app, QtUtilities::QtSettings &qtSettings, QQmlEngine *engine, const QString &mode, QObject *parent)
    ...
    , m_densityScaleIconButtons(m_style == QStringLiteral("FluentWinUI3") || m_style == QStringLiteral("Material") || m_style == QStringLiteral("Universal") ? std::max(0.95, m_densityScale) : m_densityScale)
