...
[Syncthing](https://github.com/syncthing/syncthing). Check out the
...
extension the Syncthing Tray UI shown in the [screenshots](docs/screenshots.md) is only accessible by *double*-clicking
...
of Plasma, check out the "[Supported platforms](#supported-platforms)" section.
...
## Download
Check out the [download section on the website](https://martchus.github.io/syncthingtray/#downloads-section) for an overview.
...
* Other GNU/Linux systems
    * for generic, self-contained binaries check out the [release section on GitHub](https://github.com/Martchus/syncthingtray/releases)
...
* Windows
    * for binaries check out the [release section on GitHub](https://github.com/Martchus/syncthingtray/releases)
...
* Parts of `tray/android/src/io/github/martchus/syncthingtray/Util.java` are based on
  [Catfriend1/com.nutomic.syncthingandroid.util](https://github.com/Catfriend1/syncthing-android/blob/main/app/src/main/java/com/nutomic/syncthingandroid/util/FileUtils.java),
  [researchxxl/com.nutomic.syncthingandroid.util](https://github.com/researchxxl/syncthing-android/blob/main/app/src/main/java/com/nutomic/syncthingandroid/util/FileUtils.java) and
  [Catfriend1/com.nutomic.syncthingandroid.service](https://github.com/Catfriend1/syncthing-android/blob/main/app/src/main/java/com/nutomic/syncthingandroid/service/SyncthingRunnable.java).
