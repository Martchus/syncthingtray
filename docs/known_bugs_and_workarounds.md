...
* Qt limitations and bugs
    ...
    * Qt > 6.11.0:
        * Android system bars sometimes disappear, see https://qt-project.atlassian.net/browse/QTBUG-146830. I have not worked
          around this bug because this would hinder investigating this sporadic and nonsevere problem.
    * Qt > 6.9.3 and < 6.10.1:
