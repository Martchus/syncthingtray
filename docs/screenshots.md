...
![Qt Widgets based GUI under Windows 11](/tray/resources/screenshots/windows-11.png)

## Qt Widgets based GUI under Openbox/Tint2 with dark Breeze theme
![Qt Widgets based GUI under Openbox/Tint2](/tray/resources/screenshots/tint2-dark.png)

## Plasmoid (for KDE's Plasma shell)
### Light theme
![Plasmoid (light theme)](/plasmoid/resources/screenshots/plasmoid-1.png)

### Dark theme
![Plasmoid (dark theme)](/plasmoid/resources/screenshots/plasmoid-2.png)

## Icon customization dialog
![Plasmoid (customized icons)](/tray/resources/screenshots/custom-icons.png)

## Settings dialog
![Settings dialog](/tray/resources/screenshots/settings.png)

## Web view
![Web view](/tray/resources/screenshots/webview.png)
![Web view (dark)](/tray/resources/screenshots/webview-dark.png)
