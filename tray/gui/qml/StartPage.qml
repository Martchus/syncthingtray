    ...
    initialItem: Page {
        ...
        CustomFlickable {
            ...
            ColumnLayout {
                ...
                ItemDelegate {
                    Layout.fillWidth: true
                    onClicked: stackView.push("NeededPage.qml", {dirId: "projects"}, StackView.PushTransition)
                ...
                ItemDelegate {
                    Layout.fillWidth: true
                    onClicked: {
                        stackView.pages.setCurrentIndex(2);
                        stackView.pages.currentPage.add();
                    }
                    contentItem: RowLayout {
                        spacing: 15
                        ForkAwesomeIcon {
                ...
                ItemDelegate {
                    Layout.fillWidth: true
                    onClicked: {
                        stackView.pages.setCurrentIndex(1);
                        stackView.pages.currentPage.add();
                    }
                    contentItem: RowLayout {
                        spacing: 15
