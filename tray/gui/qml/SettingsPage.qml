...
StackView {
    ...
    initialItem: Page {
        ...
        readonly property var specialEntries: ({
            ...
            launcher: [
                {key: "run", label: qsTr("Run Syncthing"), statusText: Qt.binding(() => App.launcher.runningStatus)}, // FIXME: App.launcher
                ...
                {key: "stopOnMetered", label: qsTr("Stop on metered network connection"), statusText: Qt.binding(() => App.launcher.meteredStatus)}, // FIXME: App.launcher
