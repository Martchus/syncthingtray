...
AdvancedDirConfigPage {
    ...
    specialEntries: [
        ...
        {key: "order", label: qsTr("Block Pull Order"), type: "options", desc: qsTr("The order in which needed files should be pulled from the cluster. It has no effect when the folder type is “send only”. Open the selection and go though the different options for details about them."), options: [
